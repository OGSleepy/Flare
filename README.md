...
- **📸 Stories** — Post photos and videos that expire after 24h. Kind 30315 with NIP-40 expiration.
...
| **Messages** | NIP-17 encrypted DM threads with inline story preview cards |
...
| Kind 30315 | Ephemeral stories (custom) |
...
│   ├── ChatThread.tsx     # NIP-17 DM thread with inline story preview cards
...
│   ├── nip17.ts           # NIP-17 send (rumor → seal → gift wrap) + decrypt
