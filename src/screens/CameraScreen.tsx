          ...
          <div className="relative flex-1">
            ...
            <div className="absolute bottom-4 left-4 right-4 z-10">
              <input
                ...
                maxLength={140}
                className="w-full bg-black/50 backdrop-blur border border-white/20 rounded-2xl px-4 py-3 text-white text-sm placeholder-white/40 focus:outline-none focus:border-flare-500/60"
              />
            </div>
          </div>
          <div className="flex items-center justify-between px-5 py-4 bg-black" style={{ paddingBottom: 'calc(1rem + env(safe-area-inset-bottom, 0px))' }}>
            <div>
