...
import { Flame, Chrome, Key, Wifi, Sparkles, Copy, Check, ShieldAlert, Info, Eye, EyeOff } from 'lucide-react';
...
import { fetchProfiles, fetchRelayList } from '@/lib/nostr';
import type { NostrSigner } from '@nostrify/nostrify';

type Tab = 'new' | 'extension' | 'nsec' | 'bunker';
...
export const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin }) => {
  ...
  const postLogin = async (signer: NostrSigner) => {
    ...
    setAuth(pubkey);
    onLogin(signer);
    // Run profile + relay list fetches in parallel
