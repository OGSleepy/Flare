    ...
    <div className="flex flex-col h-full">
      <main className="flex-1 overflow-hidden">
        <div className="relative flex-1 overflow-hidden">
          <div className={screen === 'camera'  ? 'block h-full' : 'hidden'}><CameraScreen signer={signer} /></div>
          <div className={screen === 'stories' ? 'block h-full' : 'hidden'}><StoriesScreen signer={signer} /></div>
          <div className={screen === 'chat'    ? 'block h-full' : 'hidden'}><ChatScreen signer={signer} /></div>
          <div className={screen === 'explore' ? 'block h-full' : 'hidden'}><ExploreScreen /></div>
          <div className={screen === 'profile' ? 'block h-full' : 'hidden'}><ProfileScreen signer={signer} /></div>
        </div>
      </main>
      <BottomNav />
      <Toaster position="top-center" theme="dark" />
